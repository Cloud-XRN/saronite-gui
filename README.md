...
Saronite is a private cryptocurrency based on Monero. Over the course of the coming months, the Saronite project aims to offer an incenvised full node layer with a secondary p2p network that offers a private communications layer based on the Signal protocol.

More information on the project can be found on the website and in the whitepaper.

Saronite is an open source project, and we encourage contributions from anyone with something to offer. For more information on contributing, please contact team@saronite.network

## About this project

This is the GUI for the [Saronite implementation](https://github.com/saronite/saronite-protocol). It is open source and completely free to use without restrictions, except for those specified in the license agreement below. There are no restrictions on anyone creating an alternative implementation of Saronite that uses the protocol and network in a compatible manner.
...
## Compiling the Saronite GUI from source

### On Linux:

(Tested on Ubuntu 17.10 x64, Ubuntu 18.04 x64 and Gentoo x64)

1. Install Saronite dependencies
...
3. Clone repository
    ...
    `git clone https://github.com/saronite/saronite-gui.git`
...
3. Install [Saronite](https://github.com/saronite/saronite-protocol) dependencies:
...
6. Grab an up-to-date copy of the saronite-gui repository
...
The Saronite GUI on Windows is 64 bits only; 32-bit Windows GUI builds are not officially supported anymore.

1. Install [MSYS2](https://www.msys2.org/), follow the instructions on that page on how to update system and packages to the latest versions

2. Open an 64-bit MSYS2 shell: Use the *MSYS2 MinGW 64-bit* shortcut, or use the `msys2_shell.cmd` batch file with a `-mingw64` parameter

3. Install MSYS2 packages for Saronite dependencies; the needed 64-bit packages have `x86_64` in their names

    ```
    pacman -S mingw-w64-x86_64-toolchain make mingw-w64-x86_64-cmake mingw-w64-x86_64-boost mingw-w64-x86_64-openssl mingw-w64-x86_64-zeromq mingw-w64-x86_64-libsodium
    ```

    You find more details about those dependencies in the [Saronite documentation](https://github.com/saronite/saronite-protocol). Note that that there is no more need to compile Boost from source; like everything else, you can install it now with a MSYS2 package.
